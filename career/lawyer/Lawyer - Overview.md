...
```mermaid
flowchart TD
    A[ม.6 Graduate<br/>Any track] --> B[Apply via TCAS<br/>คณะนิติศาสตร์]
    B --> C["LL.B. &#40;น.บ.&#41;<br/>3-4 Years"]
    C --> D{Choose Path}
    D -->|Lawyer| E["Apply to Lawyers Council<br/>+ Pass training course<br/>สำนักฝึกอบรมวิชาว่าความ"]
    E --> F["Registered Lawyer<br/>ทนายความ<br/>Get license"]
    F --> G["Practice Law<br/>Litigation / Corporate / Government"]
    D -->|Prosecutor| H["Pass อัยการผู้ช่วย exam<br/>Open exam by OAG"]
    H --> I["Assistant Prosecutor<br/>อัยการผู้ช่วย<br/>1 year probation"]
    I --> J["Public Prosecutor<br/>อัยการ"]
    D -->|Judge| K["Pass ผู้ช่วยผู้พิพากษา exam<br/>Open exam by OJC"]
    K --> L["Judge Advocate<br/>ผู้ช่วยผู้พิพากษา<br/>1 year training"]
    L --> M["Judge<br/>ผู้พิพากษา"]
    D -->|In-House| N["Legal Officer / นิติกร<br/>No license required<br/>&#40;for corporate work&#41;"]
    F --> O["เนติบัณฑิต &#40;Barrister-at-Law&#41;<br/>Thai Bar Association<br/>1 year program"]
    G --> O
    O --> P["Advanced Practice<br/>Specialization, partnership"]
```

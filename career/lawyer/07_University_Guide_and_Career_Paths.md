...
```mermaid
flowchart TD
    A["Trainee Lawyer<br/>นักศึกษาฝึกงาน<br/>0 years"] --> B["Junior Associate<br/>ทนายความรุ่นน้อง<br/>1-3 years"]
    B --> C["Senior Associate<br/>ทนายความอาวุโส<br/>4-7 years"]
    C --> D["Junior Partner<br/>หุ้นส่วนรุ่นน้อง<br/>8-12 years"]
    D --> E["Senior / Managing Partner<br/>หุ้นส่วนอาวุโส<br/>12+ years"]
    C --> F["In-House Counsel<br/>นิติกรบริษัท<br/>&#40;exit option&#41;"]
    D --> G["Start own firm<br/>เปิดสำนักงานของตนเอง"]
```

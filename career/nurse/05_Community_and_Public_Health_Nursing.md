...
flowchart LR
    ...
    subgraph "Secondary Prevention"
        B1[Screening] --> B2[Early Diagnosis]
        B2 --> B3[Prompt Treatment]
    end
    subgraph "Tertiary Prevention"
        C1[Rehabilitation] --> C2[Disability Limitation]
        C2 --> C3[Chronic Disease Mgmt]
    end
```

...
```mermaid
flowchart TD
    A["ม.6 Graduate<br/>Any track<br/>(Math ability is key)"] --> B["Apply via TCAS<br/>คณะพาณิชยศาสตร์และการบัญชี"]
    B --> C["4-Year Bachelor's<br/>บช.บ. (บัญชีบัณฑิต)<br/>B.Acc."]
    C --> D{Choose Track}
    D -->|Audit| E["CPA Path<br/>Pass CPA exam (สภาวิชาชีพบัญชี)<br/>+ 3 years audit experience"]
    E --> F["ผู้สอบบัญชีรับอนุญาต<br/>Certified Public Accountant<br/>Sign audit opinions"]
    D -->|Tax| G["Tax Consultant / ที่ปรึกษาภาษี<br/>Pass Tax Auditor exam (สรรพากร)"]
    D -->|Corporate| H["Corporate Accountant<br/>Financial Controller → CFO"]
    D -->|Management| I["Management Accountant<br/>CMA — Cost, Budget, Strategy"]
    D -->|Forensic| J["Forensic Accountant<br/>Fraud investigation, litigation support"]
    D -->|Finance| K["Financial Analyst / Investment<br/>Banking, securities, PE"]
    F --> L["Big 4 / Regional Firm<br/>Partner Track"]
    H --> M["CFO / ผู้จัดการฝ่ายการเงิน"]
```

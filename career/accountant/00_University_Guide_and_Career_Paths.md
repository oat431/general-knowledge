...
```mermaid
flowchart TD
    A["Associate / Staff<br/>พนักงานสอบบัญชี<br/>0-2 years"] --> B["Senior Associate<br/>ผู้ช่วยผู้สอบบัญชี<br/>2-4 years"]
    B --> C["Manager<br/>ผู้จัดการ<br/>4-7 years"]
    C --> D["Senior Manager<br/>ผู้จัดการอาวุโส<br/>7-10 years"]
    D --> E["Partner<br/>หุ้นส่วน<br/>10-15+ years"]
    C --> F["Exit: CFO / Controller<br/>at listed company"]
    D --> G["Exit: VP Finance /<br/>Financial Director"]
```
...
```mermaid
flowchart TD
    A["Junior Accountant<br/>พนักงานบัญชี<br/>0-2 years"] --> B["Senior Accountant<br/>นักบัญชีอาวุโส<br/>2-5 years"]
    B --> C["Accounting Supervisor<br/>หัวหน้าฝ่ายบัญชี<br/>5-8 years"]
    C --> D["Financial Controller<br/>ผู้จัดการฝ่ายการเงิน<br/>8-12 years"]
    D --> E["CFO / กรรมการผู้จัดการฝ่ายการเงิน<br/>12+ years"]
    B --> F["Specialization: Tax Manager,<br/>Internal Audit Manager,<br/>FP&A Manager"]
```

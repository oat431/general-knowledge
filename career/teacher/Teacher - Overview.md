...
graph TD
    ...
    D --> E{Pass?}
    E -->|Yes| F["Professional Teaching License<br/>ใบอนุญาตประกอบวิชาชีพครู<br/>5-year validity"]
    E -->|No| G["Provisional License<br/>ใบอนุญาตชั่วคราว<br/>Must pass within 2 years"]
    G --> E
    F --> H[Teaching Career<br/>Government / Private / International School]
    H --> I["License Renewal<br/>ต่ออายุทุก 5 ปี<br/>CPD: Professional Development"]
    F --> J["Graduate Degree<br/>ค.ม. / กศ.ม. / Ph.D."]
    J --> K[Administrator / Academic / Specialist]
```

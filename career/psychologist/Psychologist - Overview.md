...
flowchart TD
    ...
    D -->|Yes| E["2-Year Master's<br/>วท.ม. จิตวิทยาคลินิก<br/>M.Sc. Clinical Psychology"]
    D -->|No| F[Career Paths:<br/>HR, Research, Education<br/>I-O Psychology, Market Research]
    E --> G[Supervised Clinical Hours<br/>1,000+ hours internship]
    G --> H["Licensure Exam<br/>สภานักจิตวิทยา"]
    H --> I{Pass?}
    I -->|Yes| J["Licensed Psychologist<br/>นักจิตวิทยาที่ได้รับใบอนุญาต"]
    I -->|No| K[Retake Exam]
    K --> H
    J --> L[Hospital / Clinic / Private Practice<br/>Government / Academic]
    J --> M["Continuing Education<br/>ต่ออายุใบอนุญาต<br/>ทุก 5 ปี"]
    F --> N[Further study / Certification<br/>options available]
```

...
flowchart LR
    ...
    D --> E["Licensed Psychologist<br/>นักจิตวิทยา"]
    E --> F["Renewal every 5 years<br/>Continuing Education"]
```
...
flowchart TD
    ...
    C --> F["Private Practice<br/>฿50K-150K+<br/>Build own client base"]
    C --> G["Ph.D. / Doctoral<br/>Academic career<br/>Research + teaching"]
```
...
flowchart TD
    ...
    A --> E["NGO / Community Worker<br/>฿20K-30K"]
    B --> F["HR Manager / OD Director<br/>฿80K-200K+<br/>10+ years"]
    C --> G["UX Research Lead<br/>฿60K-120K+<br/>Tech companies"]
    D --> H["School Counselor<br/>฿30K-50K"]
    E --> I["Program Director<br/>฿50K-80K"]
```

...
flowchart LR
    ...
    F --> G[Publish / Replicate]
    G -->|Supports or Refines| A
```
...
flowchart TD
    ...
    D --> E[Choose and implement action]
    E --> F[Document decision + rationale]
    F --> G[Reflect: what would you do<br/>differently next time?]
```

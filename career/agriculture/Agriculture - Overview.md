...
```mermaid
flowchart TD
    A["ม.6 Graduate<br/>Any track (Sci preferred)"] --> B["Apply via TCAS<br/>คณะเกษตร / อุตสาหกรรมเกษตร<br/>เทคโนโลยีการเกษตร"]
    B --> C["4-Year Bachelor's<br/>วท.บ. เกษตรศาสตร์ / วิทยาศาสตร์การเกษตร<br/>บธ.บ. ธุรกิจเกษตร"]
    C --> D{Choose Path}
    D -->|Production| E["Smart Farmer / Farm Manager<br/>Precision agriculture, IoT, drones"]
    D -->|Business| F["Agribusiness<br/>Supply chain, export, trading, marketing"]
    D -->|Science| G["Food Scientist / R&D<br/>Product development, quality, safety"]
    D -->|Sustainability| H["Organic / BCG / Regenerative<br/>Certification, carbon credits, ESG"]
    D -->|Tech| I["AgriTech Startup<br/>Apps, sensors, platforms, AI"]
    E --> J["Master's / Ph.D.<br/>Specialization<br/>or MBA (Agribusiness)"]
    F --> J
    G --> J
    H --> J
    I --> J
    J --> K["Leadership: CEO, Policy Maker,<br/>International Consultant, Researcher"]
```

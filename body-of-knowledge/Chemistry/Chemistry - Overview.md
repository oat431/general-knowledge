---
tags: [overview, chemistry, math-sci, high-school, ipst]
---
...
```mermaid
flowchart TD
    ATOM["Atomic Structure"] --> PERIODIC["Periodic Table"]
    ATOM --> BONDING["Chemical Bonding"]
    PERIODIC --> BONDING
    BONDING --> IMFs["Intermolecular Forces"]
    BONDING --> STOICH["Stoichiometry"]
    STOICH --> SOLUTIONS["Solutions"]
    STOICH --> GASES["Gases"]
    STOICH --> ACIDS["Acids & Bases"]
    STOICH --> EQUIL["Chemical Equilibrium"]
    EQUIL --> IONIC["Ionic Equilibrium"]
    ACIDS --> IONIC
    STOICH --> THERMOC["Thermochemistry"]
    STOICH --> KINETICS["Reaction Kinetics"]
    ACIDS --> ELECTRO["Electrochemistry"]
    STOICH --> ELECTRO
    BONDING --> ORGANIC["Organic Fundamentals"]
    ORGANIC --> REACTIONS["Organic Reactions"]
    REACTIONS --> FUNCTIONAL["Functional Groups"]
    FUNCTIONAL --> POLYMERS["Polymers"]
    FUNCTIONAL --> BIOCHEM["Biochemistry"]
    ORGANIC --> QUAL["Qualitative Analysis"]
    ORGANIC --> INDUSTRIAL["Industrial Chemistry"]
```

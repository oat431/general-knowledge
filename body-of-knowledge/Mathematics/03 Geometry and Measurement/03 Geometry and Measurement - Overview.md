---
tags: [overview, fundamental-mathematics, geometry, measurement, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart TD
    SHAPES["ป.1-3: 2D shapes\n3D shapes\nSymmetry"] --> ANGLES["ป.4-6: Angles (acute/right/obtuse)\nTriangle types\nQuadrilaterals\nCongruence/Similarity"]
    ANGLES --> RELATIONS["ม.1-3: Angle relationships\nParallel lines & transversals\nPythagoras a²+b²=c²\nTrigonometry intro"]
    
    MEASURE["ป.1-3: cm, m, g, kg\nReading rulers"] --> CONVERT["ป.4-6: Metric conversions\nPerimeter\nTime (24-hour)"]
    CONVERT --> PRECISE["ม.1-3: Compound units\nSignificant figures\nSpeed = d/t"]
    
    AREA["ป.4-6: A=l×w\nA=½bh\nP formulas"] --> CIRCLE["ม.1: Circle area/circumference\nπr², 2πr\nArc length, sectors"]
    
    VOL["ป.4-6: V=l×w×h\nCounting cubes"] --> VOLADV["ม.1-3: Prisms, cylinders\nPyramids (⅓Bh)\nCones, spheres"]
    
    COORD["ป.4-6: First quadrant\n(x,y) plotting"] --> COORDADV["ม.1-3: All 4 quadrants\nSlope m = Δy/Δx\ny = mx + c\nDistance & midpoint"]
```

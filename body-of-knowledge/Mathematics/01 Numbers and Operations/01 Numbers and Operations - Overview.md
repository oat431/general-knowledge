---
tags: [overview, fundamental-mathematics, numbers, operations, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart TD
    NUM["01 Numbers & Numeration"] --> ARITH["02 Arithmetic Ops"]
    ARITH --> FACTORS["03 Factors & Multiples"]
    ARITH --> INT["04 Integers"]
    ARITH --> FRAC["05 Fractions"]
    ARITH --> DEC["06 Decimals"]
    FRAC --> RAT["07 Rational Numbers"]
    DEC --> RAT
    FRAC --> PERC["08 Percentages"]
    DEC --> PERC
    ARITH --> RATIO["09 Ratios & Proportions"]
    PERC --> RATIO
    INT --> RAT
```

---
tags: [overview, fundamental-mathematics, algebra, patterns, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart TD
    SKIP["ป.1-3: Skip counting\nRepeating patterns\nMissing numbers (3+□=7)"] --> RULES["ป.4-6: Pattern rules\nFunction machines\nInput/output tables\nOne-step solving"]
    RULES --> VAR["ม.1: Variables (x,y)\nExpressions\nLinear equations\nax+b=c"]
    VAR --> MULTI["ม.2: Multi-step equations\nVariables on both sides\nInequalities"]
    MULTI --> QUAD["ม.3: Quadratics\nax²+bx+c=0\nFactoring\nQuadratic formula"]
```

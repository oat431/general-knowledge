...
```mermaid
flowchart LR
    subgraph FOUNDATION["📗 Foundation (ป.1–ม.3)"]
        FM["Fundamental Mathematics\nค111–ค116, ค211–ค213"]
        FS["Fundamental Science\nว111–ว116, ว211–ว213"]
    end
    subgraph SPECIALIZED["📘 Specialized (ม.4–ม.6)"]
        MATH["Mathematics\nค301–ค303"]
        PHYS["Physics\nว301–ว303"]
        CHEM["Chemistry\nว311–ว313"]
        BIO["Biology\nว321–ว323"]
...
```mermaid
flowchart TD
    subgraph FOUND["📗 Foundation (ป.1–ม.3)"]
        FM["🔢 Fundamental Math"]
        FS["🔬 Fundamental Science"]
    end

    subgraph SPEC["📘 Specialized (ม.4–ม.6)"]
        MATH["🔢 Mathematics"]
        PHYS["⚛️ Physics"]
        CHEM["🧪 Chemistry"]
        BIO["🧬 Biology"]
    ...
    FM -->|"algebra, geometry, stats"| MATH
    FM -->|"number systems, logic"| CS
    FS -->|"forces, energy, waves"| PHYS
    FS -->|"matter, atoms, reactions"| CHEM
    FS -->|"life, cells, ecosystems"| BIO
    FS -->|"rocks, weather, astronomy"| ES
    MATH -->|"calculus, vectors"| PHYS
    MATH -->|"algebra, stats"| CHEM
    PHYS -->|"thermo, atomic"| CHEM
    CHEM -->|"biochemistry"| BIO
    PHYS -->|"climate models"| ES
    CHEM -->|"geochemistry"| ES
    BIO -->|"ecology"| ES
    CS -->|"simulations"| PHYS
```

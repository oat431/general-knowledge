---
tags: [overview, student-development-activities, service-learning, community-service, primary, lower-secondary, upper-secondary, obec]
source: "OBEC Basic Education Core Curriculum B.E. 2551 (2008), revised 2560 (2017)"
created: 2026-08-04
component: "กิจกรรมเพื่อสังคมและสาธารณประโยชน์"
---
...
```mermaid
flowchart TD
    NEED["Identify a need\nสำรวจปัญหา"] --> PLAN["Plan with others\nวางแผนร่วมกัน"]
    PLAN --> ACT["Take action\nลงมือปฏิบัติ"]
    ACT --> REFLECT["Reflect on learning\nสะท้อนการเรียนรู้"]
    REFLECT --> IMPROVE["Improve or continue\nปรับปรุงและต่อยอด"]
    IMPROVE --> NEED
```

---
tags: [overview, body-of-knowledge, student-development-activities, guidance, scouts, service-learning, primary, lower-secondary, upper-secondary, obec]
...
```mermaid
flowchart TD
    GUIDANCE["Guidance and Counseling\nกิจกรรมแนะแนว"] --> SELF["Self-understanding\nEducation and career planning"]
    STUDENT["Student Activities\nกิจกรรมนักเรียน"] --> PARTICIPATE["Participation\nTeamwork and leadership"]
    SERVICE["Social and Public Benefit\nกิจกรรมเพื่อสังคมฯ"] --> CONTRIBUTE["Contribution\nService and citizenship"]
    SELF --> WHOLE["Whole-person development\nการพัฒนาผู้เรียนรอบด้าน"]
    PARTICIPATE --> WHOLE
    CONTRIBUTE --> WHOLE
```

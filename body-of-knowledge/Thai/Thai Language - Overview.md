---
tags: [overview, thai-language, primary, lower-secondary, upper-secondary, thai-curriculum, obec]
---
...
```mermaid
flowchart TD
    subgraph RECEPTIVE["🎧 Receptive Skills"]
        LVS["🎙️ สาระที่ 3\nการฟัง การดู และการพูด\n(Listening/Viewing)"]
        READ["📖 สาระที่ 1\nการอ่าน\n(Reading)"]
    end
    
    subgraph PRODUCTIVE["✏️ Productive Skills"]
        WRITE["✍️ สาระที่ 2\nการเขียน\n(Writing)"]
        SPEAK["🎙️ สาระที่ 3\nการฟัง การดู และการพูด\n(Speaking)"]
    end
    ...
    subgraph APPLICATION["📜 Application & Appreciation"]
        LIT["🏛️ สาระที่ 5\nวรรณคดีและวรรณกรรม\n(Literature)"]
    end

    PRIN -->|"provides grammar, vocabulary, structure"| READ
    PRIN -->|"provides grammar, vocabulary, structure"| WRITE
    PRIN -->|"provides grammar, vocabulary, structure"| LVS
    
    READ -->|"reading literature"| LIT
    WRITE -->|"composing literary analysis"| LIT
    LVS -->|"listening to poetry, viewing performances"| LIT
    
    LVS -->|"oral comprehension → reading"| READ
    READ -->|"builds vocabulary → writing"| WRITE
    READ -->|"builds knowledge → speaking"| SPEAK
    WRITE -->|"prepares scripts → speaking"| SPEAK
    LVS -->|"oral models → writing"| WRITE
    
    LIT -->|"deepens language appreciation"| PRIN
    LIT -->|"provides reading content"| READ
    LIT -->|"provides writing models"| WRITE
```

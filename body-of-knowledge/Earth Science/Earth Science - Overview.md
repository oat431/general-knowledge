---
tags: [overview, earth-science, math-sci, high-school, ipst]
---
...
```mermaid
flowchart TD
    MINERALS["Minerals & Rocks"] --> PLATES["Plate Tectonics"]
    PLATES --> EQ["Earthquakes & Volcanoes"]
    PLATES --> WEATHERING["Weathering & Erosion"]
    MINERALS --> EARTH["Earth History"]
    EQ --> EARTH
    WEATHERING --> EARTH
    PLATES --> OCEAN["Oceanography"]
    WEATHER["Weather & Climate"] --> CLIMATE["Climate Change"]
    OCEAN --> CLIMATE
    WATER["Water Cycle"] --> CLIMATE
    WATER --> OCEAN
    SOLAR["Solar System"] --> STARS["Astronomy"]
    STARS --> EARTH
    CLIMATE --> ENVIRON["Environment"]
```

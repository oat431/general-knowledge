...
flowchart TD
    ...
    RELIG["🛕 World Religions\nand Mythology\n20 topics"]

    RELIG -->|"other religions\nbeside Buddhism"| RELSTRAND["Curriculum: Religion strand\nศีลธรรม จริยธรรม"]
    LIT -->|"รามเกียรติ์ is Ramayana"| THAILIT["Curriculum: ภาษาไทย\nวรรณคดีและวรรณกรรม"]
    LIT -->|"read in English"| ENG["Curriculum: English\nreading skills"]
    PHIL -->|"social contract"| CIVICS["Curriculum: Civics strand\nหน้าที่พลเมือง"]
    PHIL -->|"stoicism and พอเพียง"| ECON["Curriculum: Economics\nSufficiency Economy"]
    RELIG -->|"Greek tragedy and theatre"| ART["Curriculum: Arts\nPerforming Arts"]
    PHIL -->|"how science reasons"| SCI["Curriculum: Science\nScientific Method"]
```

---
tags: [overview, fundamental-science, life-science, biology, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart TD
    LIVING["ป.1-3: Living things\nPlants & animals\nBody parts"] --> CELLS["ป.4-6: Cells intro\nPhotosynthesis\nFood chains\nBasic body systems"]
    CELLS --> MOLEC["ม.1-3: Cell organelles\nEcosystems & symbiosis\nHuman organ systems\nHeredity & evolution"]
```

---
tags: [overview, fundamental-science, earth-science, astronomy, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart LR
    IG["Igneous\n(หินอัคนี)"] -->|"Weathering"| SED["Sedimentary\n(หินตะกอน)"]
    SED -->|"Heat & Pressure"| META["Metamorphic\n(หินแปร)"]
    META -->|"Melting"| MAGMA["Magma"]
    MAGMA -->|"Cooling"| IG
```

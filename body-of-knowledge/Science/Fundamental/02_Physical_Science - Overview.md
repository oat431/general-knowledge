---
tags: [overview, fundamental-science, physical-science, chemistry, physics, primary, lower-secondary, ipst]
---
...
```mermaid
flowchart TD
    MATTER["ป.1-3: States of matter\nPush/pull forces\nHot/cold, light/dark"] --> ATOMS["ป.4-6: Elements intro\nEnergy forms\nSimple circuits\nLight & sound"]
    ATOMS --> REACTIONS["ม.1-3: Atomic structure\nChemical equations\nNewton's laws\nOhm's law"]
```

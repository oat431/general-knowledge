---
tags: [overview, body-of-knowledge, english, primary, secondary, thai-curriculum]
---
...
```mermaid
flowchart LR
    subgraph PRIMARY["🏫 Primary (ป.1–ป.6)"]
        P1["ป.1–ป.3\nPreparatory\nListening & Speaking first\nBasic vocabulary"]
        P2["ป.4–ป.6\nBeginner Literacy\nReading & Writing begin\nDaily life communication"]
    end
    subgraph SECONDARY["🏫 Secondary (ม.1–ม.6)"]
...
flowchart TD
    ...
    SUB3["🔗 Strand 3\nLanguage & Other Areas\n(CLIL / Content Learning)"]
    SUB4["🌏 Strand 4\nLanguage & Community/World\n(Real-World Application)"]

    SUB1 -->|"Communication skills applied in"| SUB4
    SUB2 -->|"Cultural awareness supports"| SUB1
    SUB2 -->|"Cultural context for"| SUB3
    SUB3 -->|"Content knowledge bridges to"| SUB4
    SUB4 -->|"Real experience reinforces"| SUB1
```

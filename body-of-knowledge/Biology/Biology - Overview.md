---
tags: [overview, biology, math-sci, high-school, ipst]
---
...
```mermaid
flowchart TD
    CELL["Cell Biology"] --> MEMBRANE["Cell Membrane & Transport"]
    CELL --> BIOMOL["Biomolecules"]
    BIOMOL --> ENERGY["Cell Energy"]
    CELL --> DIVISION["Cell Division"]
    BIOMOL --> MOLBIO["Molecular Biology"]
    MOLBIO --> DIVISION
    MOLBIO --> GENETICS["Genetics"]
    GENETICS --> EVOLUTION["Evolution"]
    EVOLUTION --> DIVERSITY["Diversity of Life"]
    DIVERSITY --> MICRO["Microbiology"]
    CELL --> PLANTS["Plant Biology"]
    ENERGY --> PLANTS
    CELL --> ANIMALS["Animal Biology"]
    ANIMALS --> HUMAN["Human Body Systems"]
    HUMAN --> IMMUNE["Immune System"]
    HUMAN --> REPRO["Reproduction"]
    EVOLUTION --> ECOLOGY["Ecology"]
    HUMAN --> ECOLOGY
    ECOLOGY --> ENVIRON["Environmental Science"]
    MOLBIO --> BIOTECH["Biotechnology"]
    EVOLUTION --> BEHAVIOR["Behavioral Biology"]
    BIOTECH --> BIOETHICS["Bioethics"]
```

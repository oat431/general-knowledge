---
tags: [overview, social-studies, geography, physical-geography, human-geography, gis, environment, thai-curriculum, obec]
---
...
- [[12_World_Regions|16_World_Regions]] — ภูมิภาคของโลก: major world regions (East Asia, Southeast Asia, South Asia, Central Asia, Middle East/North Africa, Sub-Saharan Africa, Europe, Russia/Central Asia, North America, Latin America, Oceania/Australia) — physical and human characteristics of each region

### 🔬 Geographic Skills & Fieldwork
- [[14_Geographic_Skills|17_Geographic_Fieldwork]] — การศึกษาภูมิศาสตร์ภาคสนาม: observation skills, data collection methods (surveys, measurements, interviews, photography/GPS), field sketching, data presentation (graphs, charts, maps), geographic report writing, field trip planning and execution
- [[14_Geographic_Skills|18_Geographic_Data_Analysis]] — การวิเคราะห์ข้อมูลทางภูมิศาสตร์: interpreting graphs and charts (line, bar, pie, scatter, population pyramids, climate graphs/climographs), statistical analysis (mean, median, mode, range, percentages), spatial analysis (patterns, distributions, relationships), using geographic models, drawing conclusions from data
...
flowchart TD
    ...
    GEOG -->|"sacred geography\nreligious site locations\nregional religious distribution"| RELIGION
    GEOG -->|"regional governance\nadministrative geography\nASEAN = geographic entity\nenvironmental law"| CIVICS
    GEOG -->|"resource → economy\nlocation → trade\nclimate → agriculture\nphysical geography → development"| ECON
    GEOG -->|"geographic factors in history\nriver civilizations\nmountain barriers\nlocation shapes historical events"| HIST
```

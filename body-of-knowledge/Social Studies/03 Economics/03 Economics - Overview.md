---
tags: [overview, social-studies, economics, sufficiency-economy, personal-finance, thai-curriculum, obec]
---
...
flowchart TD
    ...
    RELIGION -->|"sufficiency economy grounded in\nBuddhist moderation\nethical consumption"| ECON
    CIVICS -->|"laws regulate economy\nlabor law, tax law\nconsumer protection law"| ECON
    ECON -->|"economic inequality → social issues\nfiscal policy → public services"| CIVICS
    HIST -->|"economic history of Thai kingdoms\nSukhothai-Ayutthaya trade\n1932 economic reforms"| ECON
    GEOG -->|"natural resources → economy\nlocation → trade patterns\nclimate → agriculture"| ECON
```

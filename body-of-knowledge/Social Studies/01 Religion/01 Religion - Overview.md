---
tags: [overview, social-studies, religion, morality, ethics, buddhism, thai-curriculum, obec]
---
...
flowchart TD
    ...
    RELIGION -->|"moral foundation of citizenship\nBuddhist ethics → good governance\nสังคหวัตถุ 4 → social service"| CIVICS
    RELIGION -->|"sufficiency philosophy grounded in\nBuddhist moderation (มัชฌิมาปฏิปทา)\ncontentment (สันโดษ)"| ECON
    RELIGION -->|"Buddhist history = Thai history\nBuddhism's role in each kingdom\nsacred sites as historical evidence"| HIST
    RELIGION -->|"sacred geography: temples, stupas\nBuddhist pilgrimage sites\nregional distribution of faiths"| GEOG
```

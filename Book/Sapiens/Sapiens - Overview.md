---
tags: [sapiens, overview, history, big-history]
---
...
```mermaid
flowchart TD
    COG["Cognitive Revolution<br/>(70kya): fictive language"] --> AGR["Agricultural Revolution<br/>(12kya): imagined orders at scale"]
    AGR --> UNI["Unification: money, empires, religions<br/>one imagined global order"]
    UNI --> SCI["Scientific Revolution<br/>(500ya): admitted ignorance"]
    SCI --> ALL["Alliance: science + capitalism + empire<br/>→ endless growth"]
    ALL --> HAP["The happiness question<br/>power ≠ wellbeing"]
    ALL --> BIO["Intelligent design<br/>bioengineering, cyborgs, AI"]
```
